...
<img src="./workshop/images/mparticle.svg" height=64px/> | In this workshop, you will configure real-time event flows to Amazon Personalize using the mParticle SDKs and then use that data to create customer profiles that can be used in marketing campaigns to customers via Braze. | [Real Time Personalization Events](./workshop/1-Personalization/1.2-Real-Time-Events-mParticle.ipynb) <br/><br/> [Personalized Customer Profiles and Messaging with Braze and mParticle](./workshop/6-CustomerDataPlatforms/6.3-mParticleBraze.ipynb) | 300 | 1-1.5 hours
