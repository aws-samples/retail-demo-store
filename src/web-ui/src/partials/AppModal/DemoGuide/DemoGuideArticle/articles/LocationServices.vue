<template>
  <ArticleLayout>
    <template #heading>Retail Geofencing and Location-aware Personalization
      <div class="subheading mt-0">with Amazon Location Services</div></template>
    <p>
          ...
          <template #default>
            ...
            <ul>
              ...
              <li>Ensure the email channel for the project is set to "Enabled"
                ...
                are finished deploying, but you may set it beforehand).</li>
              <li>For the email that you used when you deployed the solution
                under "Reply-To email address", ensure that the email
               address is verified. Select this as your "Default sender address".</li>
              <li>For every email to which you plan to send emails,
                ensure that the email address is verified.</li>
            ...
            <p>
              ...
              has opted in to receive promotional messages. The Retail Demo Store is at present only configured
              to allow the opt-in of phone numbers when a long code is provided and within
              the United States because of the need to verify target SMS addresses using 2-way messaging. It is possible
              to bypass this method for testing internationally but that is without of the scope of this guide. See
              the Pinpoint workshop for more details.
            </p>
          </template>
    </ArticleFeature>
