<template>
  <ArticleLayout>
    <template #heading>Amazon Pay Integration</template>
    <p>
    ...
    <div class="popout">
        <span class="note-head">Note:</span>
        <span class="note-body"> This is a partial integration that does not cover the full checkout process.
          We go as far as initiating a checkout session which you can test by logging in with a sandbox user.</span>
    </div>

    <ArticleFeature>
      <template #title>How to Set up Amazon Pay Integration</template>
      <template #default>
        <p>
          ...
          <p>Here are step-by-step instructions to get you started with Amazon Pay in the Retail Demo Store:</p>
        <ol>
          ...
          <li>Select your sandbox testing account and create a test account as explained
            <a href="https://developer.amazon.com/docs/amazon-pay-checkout/amazon-pay-sandbox-accounts.html">
              here
            </a>. This test account will be different to your merchant account. For example, your main
          ...
          <li>Obtain your account's integration details as described
            <a href="https://developer.amazon.com/docs/amazon-pay-checkout/get-set-up-for-integration.html#5-get-your-public-key-id">
              here
            </a>. The details you will need to obtain from the "Integration Central" hub in Seller Central are:
            <ul>
              <li>Your merchant ID.</li>
              <li>Your store ID.</li>
              <li>Your public API key ID.</li>
              <li>Your private key (this will be downloaded as a <span class="code-text">.pem</span> file).</li>
            </ul>
          </li>
          <li>
            ...
            this information as parameters when re-deploying your CloudFormation template.
             <span class="note-head">Note:</span>
            <span class="note-body"> Using the CloudFormation UI you will need to copy the contents of the private
            key <span class="code-text">.pem</span> file into the pivate key parameter text field.</span>
          </li>
          <li>
