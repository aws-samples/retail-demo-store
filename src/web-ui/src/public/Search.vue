      ...
      <form class="form-inline d-flex dropdown ml-auto mr-4" autocomplete="off">
        <div class="input-group">
          ...
          <ul class="search-results dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="search">
            <li class="presentation text-center text-secondary" v-if="searching">
              <i class="fas fa-spinner fa-spin fa-lg"></i>
            </li>
            <li class="presentation text-center text-secondary" v-if="!results">
              No Results
            </li>
            <li class="presentation text-center text-secondary" v-if="results && results.length < 1">
              No Results
            </li>
            <li class="presentation text-center text-secondary" v-if="reranked">
