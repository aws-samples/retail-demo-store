<template>
  <div class="content">
      ...
      <div class="row col-sm-12 col-md-12 col-lg-12 d-none d-sm-block">
        <ul class="nav nav-pills nav-fill mx-auto">
          <li class="nav-item">
            <router-link
              class="nav-link"
              :to="{ name: 'CategoryDetail', params: { id: 'featured' } }"
              v-bind:class="{ active: display == 'featured' }"
          ...
          <li class="nav-item" v-for="category in categories" v-bind:key="category.id">
            <router-link
              class="nav-link"
              :to="{ name: 'CategoryDetail', params: { id: category.name } }"
              v-bind:class="{ active: display == category.name }"
              >{{ category.name | capitalize }}</router-link
            >
          </li>
        </ul>
      </div>
    ...
    <div
      id="featuredProducts"
      class="carousel slide col-sm-12 col-md-12 col-lg-12 d-none d-md-block mb-5"
      data-ride="carousel"
    >
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            ...
            <router-link class="btn btn-outline-light" :to="{ name: 'CategoryDetail', params: { id: 'apparel' } }"
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-caption">
            ...
            <p>
              Start gearing up for summer adventures with our new fishing gear!
            </p>
            <router-link class="btn btn-outline-light" :to="{ name: 'CategoryDetail', params: { id: 'outdoors' } }"
              >See More</router-link
            >
          </div>
        </div>
        <div class="carousel-item">
          ...
          <div class="carousel-caption">
            ...
            <router-link class="btn btn-outline-light" :to="{ name: 'CategoryDetail', params: { id: 'beauty' } }"
              >See More</router-link
            >
          </div>
        </div>
    ...
    <div class="container mt-5 user-recommendations" v-if="user">
      ...
      <div class="row">
        <div class="card-deck col-sm-12 col-md-12 col-lg-12 mt-4">
          <Product
            v-for="recommendation in user_recommended"
    ...
    <div class="container guest-recommendations" v-if="!user">
      ...
      <div class="row">
        <div class="card-deck col-sm-12 col-md-12 col-lg-12 mt-4">
          <Product v-for="product in guest_recommended" v-bind:key="product.id" :product="product" :feature="feature" />
        </div>
      </div>
    </div>
  </div>
