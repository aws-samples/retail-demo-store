<template>
  <div class="content">
    ...
    <div class="container" v-if="cart">
      <div class="alert alert-secondary" v-if="!cart.items">
        No Items In Cart
      </div>
    </div>
    ...
    <div class="container" v-if="cart">
      <div v-if="cart.items">
        <div class="alert alert-secondary" v-if="cart.items.length == 0">
          No Items In Cart
        </div>
      </div>
    </div>
    ...
    <div class="container" v-if="showCheckout == false">
      <div class="row justify-content-center">
        <div class="card p-4" style="width: 15rem">
          <button class="btn btn-success mb-3" v-on:click="signIn">
            Login to Checkout
          </button>
          <button class="btn btn-light" v-on:click="guestCheckout">
            Checkout as Guest
          </button>
        </div>
      </div>
    ...
    <div class="container" v-if="cart">
      <div class="row justify-content-center" v-if="showCheckout == true">
        <div class="alert alert-secondary">
          This storefront is not real. Please do not enter actual billing information. Your order will not be fulfilled.
        </div>
      </div>
          ...
          <form>
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  id="firstName"
                  v-model="order.billing_address.first_name"
                  placeholder=""
                  value=""
                  required
                />
              ...
              <div class="col-md-6 mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  id="lastName"
                  v-model="order.billing_address.last_name"
                  placeholder=""
                  value=""
                  required
                />
            ...
            <div class="mb-3">
              ...
              <input
                ...
                class="form-control"
                id="address"
                v-model="order.billing_address.address1"
            ...
            <div class="mb-3">
              ...
              <input
                ...
                class="form-control"
                id="address2"
                v-model="order.billing_address.address2"
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-3">
                ...
                <input
                  ...
                  class="form-control"
                  id="zip"
                  v-model="order.billing_address.zipcode"
                  placeholder=""
                  required
                />
            ...
            <hr class="mb-4" />
            <button class="btn btn-primary btn-lg btn-block" v-on:click="submitOrder">
              Confirm Order
            </button>
          </form>
        </div>
