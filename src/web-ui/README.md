...
6. Open your local `.env` file and paste over the top of the lines you selected. Tthere is already a [.env.template](.env.template) file with examples of what this would look like.
