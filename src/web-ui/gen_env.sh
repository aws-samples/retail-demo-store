...
printf 'VUE_APP_EVIDENTLY_PROJECT=%s\n' "$EVIDENTLY_PROJECT" >> .env
printf 'VUE_APP_EVIDENTLY_REGION=%s\n' "$EVIDENTLY_REGION" >> .env
printf 'VUE_APP_EVIDENTLY_ENDPOINT=%s\n' "$EVIDENTLY_ENDPOINT" >> .env
